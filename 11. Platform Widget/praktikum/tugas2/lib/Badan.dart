  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      navigationBar: CupertinoNavigationBar(
        ...
        border: Border(bottom: BorderSide.none,top: BorderSide.none, left: BorderSide.none, right: BorderSide.none),
                  ...
                  Container(
                    ...
                    CupertinoSlidingSegmentedControl(
                      ...
                      children: <Tab, Widget>{
                        ...
                        Tab.work: Center(child: Text("Works"),),
                        Tab.unread: Center(child: Text("Unread"),),
                        Tab.personal: Center(child: Text("Personal"),)
                      },
                    ),
                  ),
                ],
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: CircleAvatar(
                        radius: 50,
                        backgroundImage: AssetImage(data[_selectedSegment]![index]["picture"].toString()),
                      )
                    ),
                    Column(
                        ...
                        Row(
                          ...
                          children: <Widget> [
                            Container(
                              ...
                              child: Text(data[_selectedSegment]![index]["name"].toString())),
                            Container(
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: Text(data[_selectedSegment]![index]["message"].toString())),
                            Container(
